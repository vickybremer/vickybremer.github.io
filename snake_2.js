...
let zgone = 0; // Zeit wie lange snake schneller sein soll
let gone = false; //ob snake schneller sein soll
let snakex = [300];
let snakey = [300];
let foodx;
let foody;
...
function preload() {
  ...
  startschild = loadImage("START2.png");
  feld2 = loadImage("FELD2.png");
  hsschild = loadImage("new_highscore.png");
  helpbutton = loadImage("HELP2.png");
...
//EXTRA (SNAKE WIRD UNSICHTBAR)
function invisible() {
  if (gone === true) {
    zgone++;
    if (zgone === 30) {
      //Zähler wie lange snake gone
      gone = false;
      zgone = 0;
    }
  }
